...
import {
  ...
  DollarSign, Building2 as BuildingIcon, Users,
  LogOut, Menu, Building2, ChevronDown, Check
} from 'lucide-react'
...
const managerItems = [
  { label: 'Presupuesto',  href: '/budget',     icon: DollarSign },
  { label: 'Estructuras',  href: '/structures', icon: BuildingIcon },
]
const adminItems = [
