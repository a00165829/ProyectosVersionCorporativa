...
-- Actualizar proyectos con campos nuevos
UPDATE projects SET progress=34, classification='Proyecto', priority=1, scrum_stage='En Desarrollo' WHERE id='55555555-0000-0000-0000-000000000001';
UPDATE projects SET progress=43, classification='Proyecto', priority=2, scrum_stage='En Desarrollo' WHERE id='55555555-0000-0000-0000-000000000002';
UPDATE projects SET progress=0,  classification='Mejora',   priority=3, scrum_stage='Backlog'        WHERE id='55555555-0000-0000-0000-000000000003';
UPDATE projects SET progress=100,classification='Proyecto', priority=NULL,scrum_stage='Completado'   WHERE id='55555555-0000-0000-0000-000000000004';
UPDATE projects SET progress=30, classification='Mejora',   priority=4, scrum_stage='QA / Pruebas'   WHERE id='55555555-0000-0000-0000-000000000005';
